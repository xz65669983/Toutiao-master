...
import com.meiji.elegantcommuncity.bean.news.MultiNewsArticleBean;
...
public interface IMobileVideoApi {
    ...
    /**
     * 获取视频信息
     * Api 生成较复杂 详情查看 {@linkplain com.meiji.elegantcommuncity.module.video.content.VideoContentPresenter#doLoadVideoData(String)}
